                ...
                <div className="w-full rounded-lg shadow-md bg-base-100 stats">
                    ...
                    {blog && (
                        <div className="stat">
                            ...
                            <div className="text-lg stat-value text-white"><a href={`https://${blog}`} target='_blank' rel='noreferrer'>{blog}</a></div>
                        </div>
                    )}
                    {twitter_username && (
                        <div className="stat">
                            <div className="stat-title text-md">Twitter</div>
                            <div className="text-lg stat-value text-white"><a href={`https://twitter.com/${twitter_username}`} target='_blank' rel='noreferrer'>{twitter_username}</a></div>
                        </div>
                    )}
                </div>
            </div>
